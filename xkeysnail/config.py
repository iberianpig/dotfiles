...
define_keymap(lambda wm_class: wm_class in ("Vim", "Alacritty", "Guake", "Gnome-terminal"), {
    # matrial shell
    K("C-Shift-j"): [K("Super-s")],
    K("C-Shift-k"): [K("Super-w")],
    K("C-Shift-l"): [K("Super-d")],
    K("C-Shift-h"): [K("Super-a")],
}, "all")

# Emacs-like keybindings in non-Emacs applications
define_keymap(lambda wm_class: wm_class not in ("Vim", "Alacritty", "Guake", "Gnome-terminal", "Gnome-boxes"), {
    # matrial shell
    K("C-Shift-j"): [K("Super-s")],
    K("C-Shift-k"): [K("Super-w")],
    K("C-Shift-l"): [K("Super-d")],
